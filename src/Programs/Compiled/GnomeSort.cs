...
public static class GnomeSort
{
    ...
    {
        B000_000: state = state.PSH(10); goto B001_000; // PT = , Size = 10, Colour = light red

        B001_000: state = state.PSH(22); goto B002_000; // PT = , Size = 22, Colour = red

        B002_000: state = state.PSH(23); goto B003_000; // PT = , Size = 23, Colour = dark red

        B003_000: state = state.PSH(4); goto B004_000; // PT = , Size = 4, Colour = light red

        B004_000: state = state.MUL; goto B005_000; // PT = , Size = 1, Colour = red

        B005_000: state = state.ADD; goto B006_000; // PT = , Size = 1, Colour = light yellow

        B006_000: state = state.DUP; goto B007_000; // PT = , Size = 1, Colour = light green

        B007_000: state = state.PSH(13); goto B008_000; // PT = , Size = 13, Colour = light red

        B008_000: state = state.SUB; goto B009_000; // PT = , Size = 1, Colour = red

        B009_000: state = state.DUP; goto B010_000; // PT = , Size = 1, Colour = dark yellow

        B010_000: state = state.PSH(15); goto B011_000; // PT = , Size = 15, Colour = dark magenta

        B011_000: state = state.ADD; goto B012_000; // PT = , Size = 1, Colour = light magenta

        B012_000: state = state.RD.DUP; goto B013_010; // PT = RD, Size = 1, Colour = light red

        B013_010: state = state.PSH(8); goto B013_018; // PT = , Size = 8, Colour = light blue

        B013_018: state = state.SUB; goto B013_019; // PT = , Size = 1, Colour = blue

        B013_019: state = state.PSH(2); goto B013_021; // PT = , Size = 2, Colour = dark magenta

        B013_021: state = state.ROT; goto B013_022; // PT = , Size = 1, Colour = light magenta
        ...
        B022_000: state = state.SUB; goto B023_000; // PT = , Size = 1, Colour = blue

        B023_000: state = state.PSH(9); goto B024_000; // PT = , Size = 9, Colour = dark magenta

        B024_000: state = state.PSH(23); goto B025_000; // PT = , Size = 23, Colour = light magenta

        B025_000: state = state.ADD; goto B026_000; // PT = , Size = 1, Colour = magenta

        B026_000: state = state.PSH(5); goto B027_000; // PT = , Size = 5, Colour = red

        B027_000: state = state.PSH(23); goto B028_000; // PT = , Size = 23, Colour = dark red

        B028_000: state = state.PSH(4); goto B029_000; // PT = , Size = 4, Colour = light red

        B029_000: state = state.MUL; goto B030_000; // PT = , Size = 1, Colour = red

        B030_000: state = state.ADD; goto B031_000; // PT = , Size = 1, Colour = light yellow

        B031_000: state = state.DUP; goto B032_000; // PT = , Size = 1, Colour = light green

        B032_000: state = state.PSH(20); goto B033_000; // PT = , Size = 20, Colour = light red

        B033_000: state = state.ADD; goto B034_000; // PT = , Size = 1, Colour = red

        B034_000: state = state.RD.DUP; goto B035_005; // PT = RD, Size = 1, Colour = yellow

        B035_005: state = state.PSH(13); goto B035_018; // PT = , Size = 13, Colour = light blue

        B035_018: state = state.SUB; goto B035_019; // PT = , Size = 1, Colour = blue

        B035_019: state = state.PSH(2); goto B035_021; // PT = , Size = 2, Colour = dark magenta

        B035_021: state = state.ROT; goto B035_022; // PT = , Size = 1, Colour = light magenta
        ...
        B040_000: state = state.SUB; goto B041_000; // PT = , Size = 1, Colour = dark magenta

        B041_000: state = state.PSH(5); goto B042_000; // PT = , Size = 5, Colour = light red

        B042_000: state = state.PSH(23); goto B043_000; // PT = , Size = 23, Colour = red

        B043_000: state = state.PSH(3); goto B044_000; // PT = , Size = 3, Colour = dark red

        B044_000: state = state.MUL; goto B045_000; // PT = , Size = 1, Colour = light red

        B045_000: state = state.ADD; goto B046_000; // PT = , Size = 1, Colour = dark yellow

        B046_000: state = state.PSH(9); goto B047_000; // PT = , Size = 9, Colour = dark green

        B047_000: state = state.PSH(23); goto B048_000; // PT = , Size = 23, Colour = light green

        B048_000: state = state.ADD; goto B049_000; // PT = , Size = 1, Colour = green

        B049_000: state = state.DUP; goto B050_000; // PT = , Size = 1, Colour = cyan

        B050_000: state = state.PSH(16); goto B051_000; // PT = , Size = 16, Colour = yellow

        B051_000: state = state.ADD; goto B052_000; // PT = , Size = 1, Colour = dark yellow

        B052_000: state = state.RD.DUP; goto B053_017; // PT = RD, Size = 1, Colour = dark green

        B053_017: state = state.PSH(1); goto B053_018; // PT = , Size = 1, Colour = light blue

        B053_018: state = state.ADD; goto B053_019; // PT = , Size = 1, Colour = blue

        B053_019: state = state.PSH(2); goto B053_021; // PT = , Size = 2, Colour = magenta

        B053_021: state = state.ROT; goto B053_022; // PT = , Size = 1, Colour = dark magenta
        ...
        B058_000: state = state.SUB; goto B059_000; // PT = , Size = 1, Colour = light red

        B059_000: state = state.PSH(1); goto B060_000; // PT = , Size = 1, Colour = yellow

        B060_000: state = state.PSH(23); goto B061_000; // PT = , Size = 23, Colour = dark yellow

        B061_000: state = state.PSH(5); goto B062_000; // PT = , Size = 5, Colour = light yellow

        B062_000: state = state.MUL; goto B063_000; // PT = , Size = 1, Colour = yellow

        B063_000: state = state.ADD; goto B064_000; // PT = , Size = 1, Colour = light green

        B064_000: state = state.RD.DUP; goto B065_006; // PT = RD, Size = 1, Colour = light cyan

        B065_006: state = state.PSH(12); goto B065_018; // PT = , Size = 12, Colour = light blue

        B065_018: state = state.SUB; goto B065_019; // PT = , Size = 1, Colour = blue

        B065_019: state = state.PSH(2); goto B065_021; // PT = , Size = 2, Colour = dark magenta

        B065_021: state = state.ROT; goto B065_022; // PT = , Size = 1, Colour = light magenta
        ...
        B079_000: state = state.PSH(2); goto B080_000; // PT = , Size = 2, Colour = dark cyan

        B080_000: state = state.MUL; goto B081_000; // PT = , Size = 1, Colour = light cyan

        B081_000: state = state.ADD; goto B082_000; // PT = , Size = 1, Colour = dark blue

        B082_000: state = state.PSH(10); goto B083_000; // PT = , Size = 10, Colour = dark magenta

        B083_000: state = state.PSH(1); goto B084_000; // PT = , Size = 1, Colour = light magenta

        B084_000: state = state.PSH(23); goto B085_000; // PT = , Size = 23, Colour = magenta

        B085_000: state = state.PSH(5); goto B086_000; // PT = , Size = 5, Colour = dark magenta

        B086_000: state = state.MUL; goto B087_000; // PT = , Size = 1, Colour = light magenta

        B087_000: state = state.ADD; goto B088_000; // PT = , Size = 1, Colour = dark red

        B088_000: state = state.DUP; goto B089_000; // PT = , Size = 1, Colour = dark yellow

        B089_000: state = state.PSH(15); goto B090_000; // PT = , Size = 15, Colour = dark magenta

        B090_000: state = state.SUB; goto B091_000; // PT = , Size = 1, Colour = light magenta

        B091_000: state = state.RD.DUP; goto B092_014; // PT = RD, Size = 1, Colour = red

        B092_014: state = state.PSH(4); goto B092_018; // PT = , Size = 4, Colour = light blue

        B092_018: state = state.ADD; goto B092_019; // PT = , Size = 1, Colour = blue

        B092_019: state = state.PSH(2); goto B092_021; // PT = , Size = 2, Colour = magenta

        B092_021: state = state.ROT; goto B092_022; // PT = , Size = 1, Colour = dark magenta
        ...
        B098_000: state = state.ADD; goto B099_000; // PT = , Size = 1, Colour = light red

        B099_000: state = state.PSH(18); goto B100_000; // PT = , Size = 18, Colour = light yellow

        B100_000: state = state.PSH(23); goto B101_000; // PT = , Size = 23, Colour = yellow

        B101_000: state = state.PSH(4); goto B102_000; // PT = , Size = 4, Colour = dark yellow

        B102_000: state = state.MUL; goto B103_000; // PT = , Size = 1, Colour = light yellow

        B103_000: state = state.ADD; goto B104_000; // PT = , Size = 1, Colour = dark green

        B104_000: state = state.DUP; goto B105_000; // PT = , Size = 1, Colour = dark cyan

        B105_000: state = state.PSH(5); goto B106_000; // PT = , Size = 5, Colour = dark yellow

        B106_000: state = state.SUB; goto B107_000; // PT = , Size = 1, Colour = light yellow

        B107_000: state = state.PSH(9); goto B108_000; // PT = , Size = 9, Colour = green

        B108_000: state = state.PSH(23); goto B109_000; // PT = , Size = 23, Colour = dark green

        B109_000: state = state.ADD; goto B110_000; // PT = , Size = 1, Colour = light green

        B110_000: state = state.PSH(18); goto B111_000; // PT = , Size = 18, Colour = light cyan

        B111_000: state = state.PSH(23); goto B112_000; // PT = , Size = 23, Colour = cyan

        B112_000: state = state.PSH(4); goto B113_000; // PT = , Size = 4, Colour = dark cyan

        B113_000: state = state.MUL; goto B114_000; // PT = , Size = 1, Colour = light cyan

        B114_000: state = state.ADD; goto B115_000; // PT = , Size = 1, Colour = dark blue

        B115_000: state = state.DUP; goto B116_000; // PT = , Size = 1, Colour = dark magenta

        B116_000: state = state.PSH(9); goto B117_000; // PT = , Size = 9, Colour = dark cyan

        B117_000: state = state.SUB; goto B118_000; // PT = , Size = 1, Colour = light cyan

        B118_000: state = state.DUP; goto B119_000; // PT = , Size = 1, Colour = blue

        B119_000: state = state.PSH(15); goto B120_000; // PT = , Size = 15, Colour = green

        B120_000: state = state.ADD; goto B121_000; // PT = , Size = 1, Colour = dark green

        B121_000: state = state.DUP; goto B122_000; // PT = , Size = 1, Colour = dark cyan

        B122_000: state = state.RD.DUP; goto B123_007; // PT = RD, Size = 1, Colour = dark yellow

        B123_007: state = state.PSH(11); goto B123_018; // PT = , Size = 11, Colour = light blue

        B123_018: state = state.SUB; goto B123_019; // PT = , Size = 1, Colour = blue

        B123_019: state = state.PSH(2); goto B123_021; // PT = , Size = 2, Colour = dark magenta

        B123_021: state = state.ROT; goto B123_022; // PT = , Size = 1, Colour = light magenta
        ...
        B128_000: state = state.ADD; goto B129_000; // PT = , Size = 1, Colour = light magenta

        B129_000: state = state.PSH(9); goto B130_000; // PT = , Size = 9, Colour = light red

        B130_000: state = state.PSH(23); goto B131_000; // PT = , Size = 23, Colour = red

        B131_000: state = state.ADD; goto B132_000; // PT = , Size = 1, Colour = dark red

        B132_000: state = state.PSH(17); goto B133_000; // PT = , Size = 17, Colour = dark yellow

        B133_000: state = state.PSH(23); goto B134_000; // PT = , Size = 23, Colour = light yellow

        B134_000: state = state.PSH(4); goto B135_000; // PT = , Size = 4, Colour = yellow

        B135_000: state = state.MUL; goto B136_000; // PT = , Size = 1, Colour = dark yellow

        B136_000: state = state.ADD; goto B137_000; // PT = , Size = 1, Colour = green

        B137_000: state = state.DUP; goto B138_000; // PT = , Size = 1, Colour = cyan

        B138_000: state = state.PSH(12); goto B139_000; // PT = , Size = 12, Colour = yellow

        B139_000: state = state.SUB; goto B140_000; // PT = , Size = 1, Colour = dark yellow

        B140_000: state = state.DUP; goto B141_000; // PT = , Size = 1, Colour = light green

        B141_000: state = state.PSH(17); goto B142_000; // PT = , Size = 17, Colour = light red

        B142_000: state = state.ADD; goto B143_000; // PT = , Size = 1, Colour = red

        B143_000: state = state.RD.DUP; goto B144_007; // PT = RD, Size = 1, Colour = yellow

        B144_007: state = state.PSH(11); goto B144_018; // PT = , Size = 11, Colour = light blue

        B144_018: state = state.SUB; goto B144_019; // PT = , Size = 1, Colour = blue

        B144_019: state = state.PSH(2); goto B144_021; // PT = , Size = 2, Colour = dark magenta

        B144_021: state = state.ROT; goto B144_022; // PT = , Size = 1, Colour = light magenta
        ...
        B149_000: state = state.SUB; goto B150_000; // PT = , Size = 1, Colour = dark magenta

        B150_000: state = state.PSH(9); goto B151_000; // PT = , Size = 9, Colour = light red

        B151_000: state = state.PSH(23); goto B152_000; // PT = , Size = 23, Colour = red

        B152_000: state = state.ADD; goto B153_000; // PT = , Size = 1, Colour = dark red

        B153_000: state = state.PSH(11); goto B154_000; // PT = , Size = 11, Colour = dark yellow

        B154_000: state = state.PSH(23); goto B155_000; // PT = , Size = 23, Colour = light yellow

        B155_000: state = state.PSH(4); goto B156_000; // PT = , Size = 4, Colour = yellow

        B156_000: state = state.MUL; goto B157_000; // PT = , Size = 1, Colour = dark yellow

        B157_000: state = state.ADD; goto B158_000; // PT = , Size = 1, Colour = green

        B158_000: state = state.RD.DUP; goto B159_011; // PT = RD, Size = 1, Colour = cyan

        B159_011: state = state.PSH(7); goto B159_018; // PT = , Size = 7, Colour = light blue

        B159_018: state = state.ADD; goto B159_019; // PT = , Size = 1, Colour = blue

        B159_019: state = state.PSH(2); goto B159_021; // PT = , Size = 2, Colour = magenta

        B159_021: state = state.ROT; goto B159_022; // PT = , Size = 1, Colour = dark magenta
        ...
        B169_000: state = state.ADD; goto B170_000; // PT = , Size = 1, Colour = light cyan

        B170_000: state = state.PSH(5); goto B171_000; // PT = , Size = 5, Colour = light blue

        B171_000: state = state.PSH(23); goto B172_000; // PT = , Size = 23, Colour = blue

        B172_000: state = state.PSH(4); goto B173_000; // PT = , Size = 4, Colour = dark blue

        B173_000: state = state.MUL; goto B174_000; // PT = , Size = 1, Colour = light blue

        B174_000: state = state.ADD; goto B175_000; // PT = , Size = 1, Colour = dark magenta

        B175_000: state = state.PSH(9); goto B176_000; // PT = , Size = 9, Colour = dark red

        B176_000: state = state.PSH(23); goto B177_000; // PT = , Size = 23, Colour = light red

        B177_000: state = state.ADD; goto B178_000; // PT = , Size = 1, Colour = red

        B178_000: state = state.PSH(12); goto B179_000; // PT = , Size = 12, Colour = yellow

        B179_000: state = state.PSH(23); goto B180_000; // PT = , Size = 23, Colour = dark yellow

        B180_000: state = state.PSH(2); goto B181_000; // PT = , Size = 2, Colour = light yellow

        B181_000: state = state.MUL; goto B182_000; // PT = , Size = 1, Colour = yellow

        B182_000: state = state.ADD; goto B183_000; // PT = , Size = 1, Colour = light green

        B183_000: state = state.PSH(1); goto B184_000; // PT = , Size = 1, Colour = light cyan

        B184_000: state = state.PSH(23); goto B185_000; // PT = , Size = 23, Colour = cyan

        B185_000: state = state.PSH(5); goto B186_000; // PT = , Size = 5, Colour = dark cyan

        B186_000: state = state.MUL; goto B187_000; // PT = , Size = 1, Colour = light cyan

        B187_000: state = state.ADD; goto B188_000; // PT = , Size = 1, Colour = dark blue

        B188_000: state = state.RD.DUP; goto B189_016; // PT = RD, Size = 1, Colour = dark magenta

        B189_016: state = state.PSH(2); goto B189_018; // PT = , Size = 2, Colour = light blue

        B189_018: state = state.SUB; goto B189_019; // PT = , Size = 1, Colour = blue

        B189_019: state = state.PSH(2); goto B189_021; // PT = , Size = 2, Colour = dark magenta

        B189_021: state = state.ROT; goto B189_022; // PT = , Size = 1, Colour = light magenta
        ...
        B194_000: state = state.SUB; goto B195_000; // PT = , Size = 1, Colour = light cyan

        B195_000: state = state.DUP; goto B196_000; // PT = , Size = 1, Colour = blue

        B196_000: state = state.PSH(4); goto B197_000; // PT = , Size = 4, Colour = green

        B197_000: state = state.ADD; goto B198_000; // PT = , Size = 1, Colour = dark green

        B198_000: state = state.PSH(11); goto B199_000; // PT = , Size = 11, Colour = dark cyan

        B199_000: state = state.PSH(23); goto B200_000; // PT = , Size = 23, Colour = light cyan

        B200_000: state = state.PSH(3); goto B201_000; // PT = , Size = 3, Colour = cyan

        B201_000: state = state.MUL; goto B202_000; // PT = , Size = 1, Colour = dark cyan

        B202_000: state = state.ADD; goto B203_000; // PT = , Size = 1, Colour = blue

        B203_000: state = state.PSH(6); goto B204_000; // PT = , Size = 6, Colour = magenta

        B204_000: state = state.PSH(23); goto B205_000; // PT = , Size = 23, Colour = dark magenta

        B205_000: state = state.PSH(3); goto B206_000; // PT = , Size = 3, Colour = light magenta

        B206_000: state = state.MUL; goto B207_000; // PT = , Size = 1, Colour = magenta

        B207_000: state = state.ADD; goto B208_000; // PT = , Size = 1, Colour = light red

        B208_000: state = state.RD.PSH(2); goto B211_002; // PT = RD, Size = 1, Colour = light yellow
        ...
        B213_014: state = state.LR.PSH(10); goto B215_000; // PT = LR, Size = 1, Colour = cyan

        B215_000: state = state.PSH(17); goto B216_000; // PT = , Size = 17, Colour = yellow

        B216_000: state = state.PSH(23); goto B217_000; // PT = , Size = 23, Colour = dark yellow

        B217_000: state = state.PSH(2); goto B218_000; // PT = , Size = 2, Colour = light yellow

        B218_000: state = state.MUL; goto B219_000; // PT = , Size = 1, Colour = yellow

        B219_000: state = state.ADD; goto B220_000; // PT = , Size = 1, Colour = light green

        B220_000: state = state.PSH(8); goto B221_000; // PT = , Size = 8, Colour = light cyan

        B221_000: state = state.PSH(23); goto B222_000; // PT = , Size = 23, Colour = cyan

        B222_000: state = state.PSH(4); goto B223_000; // PT = , Size = 4, Colour = dark cyan

        B223_000: state = state.MUL; goto B224_000; // PT = , Size = 1, Colour = light cyan
        ...
        B224_000: state = state.ADD; goto B225_000; // PT = , Size = 1, Colour = dark blue

        B225_000: state = state.DUP; goto B226_000; // PT = , Size = 1, Colour = dark magenta

        B226_000: state = state.PSH(1); goto B227_000; // PT = , Size = 1, Colour = dark cyan

        B227_000: state = state.ADD; goto B228_000; // PT = , Size = 1, Colour = light cyan

        B228_000: state = state.DUP; goto B229_000; // PT = , Size = 1, Colour = light blue

        B229_000: state = state.PSH(15); goto B230_000; // PT = , Size = 15, Colour = light green

        B230_000: state = state.ADD; goto B231_000; // PT = , Size = 1, Colour = green

        B231_000: state = state.RD.DUP; goto B232_016; // PT = RD, Size = 1, Colour = cyan

        B232_016: state = state.PSH(2); goto B232_018; // PT = , Size = 2, Colour = light blue

        B232_018: state = state.SUB; goto B232_019; // PT = , Size = 1, Colour = blue

        B232_019: state = state.PSH(2); goto B232_021; // PT = , Size = 2, Colour = dark magenta

        B232_021: state = state.ROT; goto B232_022; // PT = , Size = 1, Colour = light magenta
        ...
        B238_000: state = state.ADD; goto B239_000; // PT = , Size = 1, Colour = light cyan

        B239_000: state = state.PSH(9); goto B240_000; // PT = , Size = 9, Colour = light blue

        B240_000: state = state.PSH(23); goto B241_000; // PT = , Size = 23, Colour = blue

        B241_000: state = state.PSH(4); goto B242_000; // PT = , Size = 4, Colour = dark blue

        B242_000: state = state.MUL; goto B243_000; // PT = , Size = 1, Colour = light blue

        B243_000: state = state.ADD; goto B244_000; // PT = , Size = 1, Colour = dark magenta

        B244_000: state = state.DUP; goto B245_000; // PT = , Size = 1, Colour = dark red

        B245_000: state = state.PSH(3); goto B246_000; // PT = , Size = 3, Colour = dark blue

        B246_000: state = state.SUB; goto B247_000; // PT = , Size = 1, Colour = light blue

        B247_000: state = state.PSH(9); goto B248_000; // PT = , Size = 9, Colour = magenta

        B248_000: state = state.PSH(23); goto B249_000; // PT = , Size = 23, Colour = dark magenta

        B249_000: state = state.ADD; goto B250_000; // PT = , Size = 1, Colour = light magenta

        B250_000: state = state.PSH(19); goto B251_000; // PT = , Size = 19, Colour = light red

        B251_000: state = state.PSH(23); goto B252_000; // PT = , Size = 23, Colour = red

        B252_000: state = state.PSH(4); goto B253_000; // PT = , Size = 4, Colour = dark red

        B253_000: state = state.MUL; goto B254_000; // PT = , Size = 1, Colour = light red

        B254_000: state = state.ADD; goto B255_000; // PT = , Size = 1, Colour = dark yellow

        B255_000: state = state.DUP; goto B256_000; // PT = , Size = 1, Colour = dark green

        B256_000: state = state.PSH(5); goto B257_000; // PT = , Size = 5, Colour = dark red

        B257_000: state = state.ADD; goto B258_000; // PT = , Size = 1, Colour = light red

        B258_000: state = state.PSH(9); goto B259_000; // PT = , Size = 9, Colour = light yellow

        B259_000: state = state.PSH(23); goto B260_000; // PT = , Size = 23, Colour = yellow

        B260_000: state = state.ADD; goto B261_000; // PT = , Size = 1, Colour = dark yellow

        B261_000: state = state.PSH(23); goto B262_000; // PT = , Size = 23, Colour = dark green

        B262_000: state = state.PSH(5); goto B263_000; // PT = , Size = 5, Colour = light green

        B263_000: state = state.MUL; goto B264_000; // PT = , Size = 1, Colour = green

        B264_000: state = state.RD.DUP; goto B265_017; // PT = RD, Size = 1, Colour = light cyan

        B265_017: state = state.PSH(1); goto B265_018; // PT = , Size = 1, Colour = light blue

        B265_018: state = state.ADD; goto B265_019; // PT = , Size = 1, Colour = blue

        B265_019: state = state.PSH(2); goto B265_021; // PT = , Size = 2, Colour = magenta

        B265_021: state = state.ROT; goto B265_022; // PT = , Size = 1, Colour = dark magenta
        ...
        B278_000: state = state.SUB; goto B279_000; // PT = , Size = 1, Colour = yellow

        B279_000: state = state.PSH(9); goto B280_000; // PT = , Size = 9, Colour = dark green

        B280_000: state = state.PSH(23); goto B281_000; // PT = , Size = 23, Colour = light green

        B281_000: state = state.ADD; goto B282_000; // PT = , Size = 1, Colour = green

        B282_000: state = state.PSH(6); goto B283_000; // PT = , Size = 6, Colour = cyan

        B283_000: state = state.PSH(23); goto B284_000; // PT = , Size = 23, Colour = dark cyan

        B284_000: state = state.PSH(5); goto B285_000; // PT = , Size = 5, Colour = light cyan

        B285_000: state = state.MUL; goto B286_000; // PT = , Size = 1, Colour = cyan

        B286_000: state = state.ADD; goto B287_000; // PT = , Size = 1, Colour = light blue

        B287_000: state = state.RD.DUP; goto B288_007; // PT = RD, Size = 1, Colour = light magenta

        B288_007: state = state.PSH(11); goto B288_018; // PT = , Size = 11, Colour = light blue

        B288_018: state = state.SUB; goto B288_019; // PT = , Size = 1, Colour = blue

        B288_019: state = state.PSH(2); goto B288_021; // PT = , Size = 2, Colour = dark magenta

        B288_021: state = state.ROT; goto B288_022; // PT = , Size = 1, Colour = light magenta
        ...
        B293_000: state = state.ADD; goto B294_000; // PT = , Size = 1, Colour = cyan

        B294_000: state = state.PSH(9); goto B295_000; // PT = , Size = 9, Colour = blue

        B295_000: state = state.PSH(23); goto B296_000; // PT = , Size = 23, Colour = dark blue

        B296_000: state = state.ADD; goto B297_000; // PT = , Size = 1, Colour = light blue

        B297_000: state = state.PSH(4); goto B298_000; // PT = , Size = 4, Colour = light magenta

        B298_000: state = state.PSH(23); goto B299_000; // PT = , Size = 23, Colour = magenta

        B299_000: state = state.PSH(5); goto B300_000; // PT = , Size = 5, Colour = dark magenta

        B300_000: state = state.MUL; goto B301_000; // PT = , Size = 1, Colour = light magenta

        B301_000: state = state.ADD; goto B302_000; // PT = , Size = 1, Colour = dark red

        B302_000: state = state.DUP; goto B303_000; // PT = , Size = 1, Colour = dark yellow

        B303_000: state = state.PSH(8); goto B304_000; // PT = , Size = 8, Colour = dark magenta

        B304_000: state = state.SUB; goto B305_000; // PT = , Size = 1, Colour = light magenta

        B305_000: state = state.PSH(3); goto B306_000; // PT = , Size = 3, Colour = red

        B306_000: state = state.PSH(23); goto B307_000; // PT = , Size = 23, Colour = dark red

        B307_000: state = state.PSH(3); goto B308_000; // PT = , Size = 3, Colour = light red

        B308_000: state = state.MUL; goto B309_000; // PT = , Size = 1, Colour = red

        B309_000: state = state.ADD; goto B310_000; // PT = , Size = 1, Colour = light yellow

        B310_000: state = state.PSH(9); goto B311_000; // PT = , Size = 9, Colour = light green

        B311_000: state = state.PSH(23); goto B312_000; // PT = , Size = 23, Colour = green

        B312_000: state = state.ADD; goto B313_000; // PT = , Size = 1, Colour = dark green

        B313_000: state = state.RD.PSH(2); goto B316_002; // PT = RD, Size = 1, Colour = dark cyan
        ...
        B318_014: state = state.LR.INi; goto B320_000; // PT = LR, Size = 1, Colour = cyan

        B320_000: state = state.PSH(1); goto B321_000; // PT = , Size = 1, Colour = yellow

        B321_000: state = state.NOT; goto B322_000; // PT = , Size = 1, Colour = dark yellow

        B322_000: state = state.PSH(10); goto B323_000; // PT = , Size = 10, Colour = cyan

        B323_000: state = state.PSH(12); goto B324_000; // PT = , Size = 12, Colour = dark cyan

        B324_000: state = state.PSH(23); goto B325_000; // PT = , Size = 23, Colour = light cyan

        B325_000: state = state.PSH(2); goto B326_000; // PT = , Size = 2, Colour = cyan

        B326_000: state = state.MUL; goto B327_000; // PT = , Size = 1, Colour = dark cyan

        B327_000: state = state.ADD; goto B328_000; // PT = , Size = 1, Colour = blue

        B328_000: state = state.PSH(23); goto B329_000; // PT = , Size = 23, Colour = magenta
        ...
        B329_000: state = state.PSH(5); goto B330_000; // PT = , Size = 5, Colour = dark magenta

        B330_000: state = state.MUL; goto B331_000; // PT = , Size = 1, Colour = light magenta

        B331_000: state = state.RD.DUP; goto B332_017; // PT = RD, Size = 1, Colour = dark red

        B332_017: state = state.PSH(1); goto B332_018; // PT = , Size = 1, Colour = light blue

        B332_018: state = state.ADD; goto B332_019; // PT = , Size = 1, Colour = blue

        B332_019: state = state.PSH(2); goto B332_021; // PT = , Size = 2, Colour = magenta

        B332_021: state = state.ROT; goto B332_022; // PT = , Size = 1, Colour = dark magenta
        ...
        B345_000: state = state.SUB; goto B346_000; // PT = , Size = 1, Colour = light blue

        B346_000: state = state.PSH(10); goto B347_000; // PT = , Size = 10, Colour = magenta

        B347_000: state = state.RD.PSH(2); goto B350_002; // PT = RD, Size = 1, Colour = dark magenta
        ...
        B352_014: state = state.LR.INi; goto B356_000; // PT = LR, Size = 1, Colour = cyan
        ...
        B399_000: state = state.PSH(3); goto B402_000; // PT = , Size = 1, Colour = cyan
        ...
        B355_000: state = state.RR.INi; goto B356_000; // PT = RR, Size = 1, Colour = dark magenta
        ...
        B059_046: state = state.PSH(1); goto B058_047; // PT = , Size = 1, Colour = red
        ...
        B058_047: state = state.PSH(2); goto B059_048; // PT = , Size = 2, Colour = dark red
        ...
        B059_048: state = state.SUB; goto B059_049; // PT = , Size = 1, Colour = light red
        ...
        B059_049: state = state.ROL; goto B058_050; // PT = , Size = 1, Colour = yellow
        ...
        B058_050: state = state.PSH(2); goto B059_051; // PT = , Size = 2, Colour = dark magenta
        ...
        B059_051: state = state.PSH(1); goto B059_052; // PT = , Size = 1, Colour = light magenta
        ...
        B059_052: state = state.ROL; goto B059_053; // PT = , Size = 1, Colour = magenta
        ...
        B059_053: state = state.PSH(1); goto B059_054; // PT = , Size = 1, Colour = dark cyan
        ...
        B059_054: state = state.ADD; goto B059_055; // PT = , Size = 1, Colour = light cyan
        ...
        B059_055: state = state.PSH(1); goto B059_056; // PT = , Size = 1, Colour = light blue
        ...
        B059_056: state = state.ROL; goto B059_057; // PT = , Size = 1, Colour = blue
        ...
        B059_057: state = state.PSH(1); goto B059_058; // PT = , Size = 1, Colour = dark green
        ...
        B059_058: state = state.NOT; goto B050_059; // PT = , Size = 1, Colour = light green
        ...
        B050_059: state = state.PSH(10); goto B048_060; // PT = , Size = 10, Colour = dark blue
        ...
        B048_060: state = state.PSH(12); goto B037_061; // PT = , Size = 12, Colour = light blue
        ...
        B037_061: state = state.PSH(23); goto B058_062; // PT = , Size = 23, Colour = blue
        ...
        B058_062: state = state.PSH(2); goto B059_063; // PT = , Size = 2, Colour = dark blue
        ...
        B059_063: state = state.MUL; goto B059_064; // PT = , Size = 1, Colour = light blue
        ...
        B059_064: state = state.ADD; goto B059_065; // PT = , Size = 1, Colour = dark magenta
        ...
        B059_065: state = state.PSH(1); goto B037_066; // PT = , Size = 1, Colour = dark red
        ...
        B037_066: state = state.PSH(23); goto B055_067; // PT = , Size = 23, Colour = light red
        ...
        B442_000: state = state.SWI; goto B439_000; // PT = , Size = 2, Colour = red

        B055_067: state = state.PSH(5); goto B059_068; // PT = , Size = 5, Colour = red
        ...
        B059_068: state = state.MUL; goto B059_069; // PT = , Size = 1, Colour = dark red
        ...
        B059_069: state = state.ADD; goto B059_070; // PT = , Size = 1, Colour = yellow
        ...
        B059_070: state = state.RL.DUP; goto B042_071; // PT = RL, Size = 1, Colour = green
        ...
        B042_071: state = state.PSH(1); goto B041_071; // PT = , Size = 1, Colour = light blue
        ...
        B041_071: state = state.SUB; goto B039_071; // PT = , Size = 1, Colour = blue
        ...
        B039_071: state = state.PSH(2); goto B038_071; // PT = , Size = 2, Colour = dark magenta
        ...
        B038_071: state = state.ROT; goto B037_071; // PT = , Size = 1, Colour = light magenta
        ...
        B059_076: state = state.ADD; goto B051_077; // PT = , Size = 1, Colour = dark red
        ...
        B051_077: state = state.PSH(9); goto B037_078; // PT = , Size = 9, Colour = dark yellow
        ...
        B037_078: state = state.PSH(23); goto B059_079; // PT = , Size = 23, Colour = light yellow
        ...
        B059_079: state = state.ADD; goto B052_080; // PT = , Size = 1, Colour = yellow
        ...
        B052_080: state = state.PSH(8); goto B037_081; // PT = , Size = 8, Colour = green

        B401_000: state = state.NOT; goto B398_000; // PT = , Size = 3, Colour = cyan
        ...
        B037_081: state = state.PSH(23); goto B056_082; // PT = , Size = 23, Colour = dark green
        ...
        B496_000: state = state.RR.PSH(1); goto B497_000; // PT = RR, Size = 1, Colour = light magenta

        B056_082: state = state.PSH(4); goto B059_083; // PT = , Size = 4, Colour = light green
        ...
        B059_083: state = state.MUL; goto B059_084; // PT = , Size = 1, Colour = green
        ...
        B059_084: state = state.ADD; goto B059_085; // PT = , Size = 1, Colour = light cyan
        ...
        B059_085: state = state.DUP; goto B059_086; // PT = , Size = 1, Colour = light blue
        ...
        B059_086: state = state.PSH(1); goto B059_087; // PT = , Size = 1, Colour = light green
        ...
        B059_087: state = state.ADD; goto B059_088; // PT = , Size = 1, Colour = green
        ...
        B059_088: state = state.DUP; goto B045_089; // PT = , Size = 1, Colour = cyan
        ...
        B045_089: state = state.PSH(15); goto B059_090; // PT = , Size = 15, Colour = yellow
        ...
        B059_090: state = state.ADD; goto B059_091; // PT = , Size = 1, Colour = dark yellow
        ...
        B059_091: state = state.RL.DUP; goto B042_092; // PT = RL, Size = 1, Colour = dark green
        ...
        B042_092: state = state.PSH(2); goto B041_092; // PT = , Size = 2, Colour = light blue
        ...
        B041_092: state = state.SUB; goto B039_092; // PT = , Size = 1, Colour = blue
        ...
        B039_092: state = state.PSH(2); goto B038_092; // PT = , Size = 2, Colour = dark magenta
        ...
        B038_092: state = state.ROT; goto B037_092; // PT = , Size = 1, Colour = light magenta
        ...
        B380_000: state = state.SWI; goto B377_000; // PT = , Size = 1, Colour = light cyan
        ...
        B059_098: state = state.ADD; goto B051_099; // PT = , Size = 1, Colour = green
        ...
        B051_099: state = state.PSH(9); goto B037_100; // PT = , Size = 9, Colour = cyan
        ...
        B037_100: state = state.PSH(23); goto B056_101; // PT = , Size = 23, Colour = dark cyan
        ...
        B056_101: state = state.PSH(4); goto B059_102; // PT = , Size = 4, Colour = light cyan
        ...
        B059_102: state = state.MUL; goto B059_103; // PT = , Size = 1, Colour = cyan
        ...
        B059_103: state = state.ADD; goto B059_104; // PT = , Size = 1, Colour = light blue
        ...
        B059_104: state = state.DUP; goto B057_105; // PT = , Size = 1, Colour = light magenta
        ...
        B057_105: state = state.PSH(3); goto B059_106; // PT = , Size = 3, Colour = light cyan
        ...
        B059_106: state = state.ADD; goto B059_107; // PT = , Size = 1, Colour = cyan
        ...
        B059_107: state = state.DUP; goto B048_108; // PT = , Size = 1, Colour = blue
        ...
        B455_000: state = state.SWI; goto B452_000; // PT = , Size = 3, Colour = dark red

        B048_108: state = state.PSH(12); goto B059_109; // PT = , Size = 12, Colour = green
        ...
        B059_109: state = state.ADD; goto B043_110; // PT = , Size = 1, Colour = dark green
        ...
        B043_110: state = state.PSH(17); goto B059_111; // PT = , Size = 17, Colour = dark cyan
        ...
        B059_111: state = state.RL.PSH(2); goto B057_114; // PT = RL, Size = 1, Colour = light cyan
        ...
        B013_045: state = state.LD.PSH(3); goto B015_046; // PT = LD, Size = 3, Colour = light red
        ...
        B013_099: state = state.LD.PSH(3); goto B015_100; // PT = LD, Size = 3, Colour = dark blue
        ...
        B015_092: state = state.PSH(1); goto B015_095; // PT = , Size = 1, Colour = light yellow
        ...
        B045_116: state = state.LD.PSH(3); goto B059_120; // PT = LD, Size = 1, Colour = cyan
        ...
        B013_065: state = state.SWI; goto B015_062; // PT = , Size = 3, Colour = dark blue
        ...
        B302_045: state = state.ADD; goto B303_045; // PT = , Size = 1, Colour = dark red

        B303_045: state = state.PSH(23); goto B304_045; // PT = , Size = 23, Colour = dark yellow

        B304_045: state = state.PSH(5); goto B305_045; // PT = , Size = 5, Colour = light yellow

        B305_045: state = state.MUL; goto B306_045; // PT = , Size = 1, Colour = yellow

        B306_045: state = state.DUP; goto B307_045; // PT = , Size = 1, Colour = light green

        B307_045: state = state.PSH(10); goto B308_045; // PT = , Size = 10, Colour = light red

        B308_045: state = state.SUB; goto B309_045; // PT = , Size = 1, Colour = red

        B309_045: state = state.PSH(9); goto B310_045; // PT = , Size = 9, Colour = dark yellow

        B023_045: state = state.LD.PSH(3); goto B025_046; // PT = LD, Size = 3, Colour = light red

        B310_045: state = state.PSH(23); goto B311_045; // PT = , Size = 23, Colour = light yellow

        B311_045: state = state.ADD; goto B312_045; // PT = , Size = 1, Colour = yellow

        B312_045: state = state.PSH(22); goto B313_045; // PT = , Size = 22, Colour = green

        B313_045: state = state.PSH(23); goto B314_045; // PT = , Size = 23, Colour = dark green

        B314_045: state = state.PSH(4); goto B315_045; // PT = , Size = 4, Colour = light green

        B315_045: state = state.MUL; goto B316_045; // PT = , Size = 1, Colour = green

        B316_045: state = state.ADD; goto B317_045; // PT = , Size = 1, Colour = light cyan

        B317_045: state = state.DUP; goto B318_045; // PT = , Size = 1, Colour = light blue

        B318_045: state = state.PSH(13); goto B319_045; // PT = , Size = 13, Colour = light green

        B319_045: state = state.SUB; goto B320_045; // PT = , Size = 1, Colour = green

        B320_045: state = state.DUP; goto B321_045; // PT = , Size = 1, Colour = dark cyan

        B321_045: state = state.PSH(15); goto B322_045; // PT = , Size = 15, Colour = dark yellow

        B322_045: state = state.ADD; goto B323_045; // PT = , Size = 1, Colour = light yellow

        B323_045: state = state.RD.DUP; goto B324_055; // PT = RD, Size = 1, Colour = light green

        B057_119: state = state.LD.PSH(3); goto B059_120; // PT = LD, Size = 3, Colour = light cyan

        B324_055: state = state.PSH(8); goto B324_063; // PT = , Size = 8, Colour = light blue

        B324_063: state = state.SUB; goto B324_064; // PT = , Size = 1, Colour = blue

        B324_064: state = state.PSH(2); goto B324_066; // PT = , Size = 2, Colour = dark magenta

        B324_066: state = state.ROT; goto B324_067; // PT = , Size = 1, Colour = light magenta
        ...
        B333_045: state = state.SUB; goto B334_045; // PT = , Size = 1, Colour = red

        B334_045: state = state.PSH(9); goto B335_045; // PT = , Size = 9, Colour = dark yellow

        B335_045: state = state.PSH(23); goto B336_045; // PT = , Size = 23, Colour = light yellow

        B336_045: state = state.ADD; goto B337_045; // PT = , Size = 1, Colour = yellow

        B337_045: state = state.PSH(5); goto B338_045; // PT = , Size = 5, Colour = green

        B338_045: state = state.PSH(23); goto B339_045; // PT = , Size = 23, Colour = dark green

        B339_045: state = state.PSH(4); goto B340_045; // PT = , Size = 4, Colour = light green

        B340_045: state = state.MUL; goto B341_045; // PT = , Size = 1, Colour = green

        B341_045: state = state.ADD; goto B342_045; // PT = , Size = 1, Colour = light cyan

        B342_045: state = state.DUP; goto B343_045; // PT = , Size = 1, Colour = light blue

        B343_045: state = state.PSH(20); goto B344_045; // PT = , Size = 20, Colour = light green

        B344_045: state = state.ADD; goto B345_045; // PT = , Size = 1, Colour = green

        B345_045: state = state.RD.DUP; goto B346_050; // PT = RD, Size = 1, Colour = cyan

        B346_050: state = state.PSH(13); goto B346_063; // PT = , Size = 13, Colour = light blue

        B346_063: state = state.SUB; goto B346_064; // PT = , Size = 1, Colour = blue

        B346_064: state = state.PSH(2); goto B346_066; // PT = , Size = 2, Colour = dark magenta

        B346_066: state = state.ROT; goto B346_067; // PT = , Size = 1, Colour = light magenta
        ...
        B351_045: state = state.SUB; goto B352_045; // PT = , Size = 1, Colour = dark yellow

        B352_045: state = state.PSH(5); goto B353_045; // PT = , Size = 5, Colour = light green

        B353_045: state = state.PSH(23); goto B354_045; // PT = , Size = 23, Colour = green

        B354_045: state = state.PSH(3); goto B355_045; // PT = , Size = 3, Colour = dark green

        B355_045: state = state.MUL; goto B356_045; // PT = , Size = 1, Colour = light green

        B356_045: state = state.ADD; goto B357_045; // PT = , Size = 1, Colour = dark cyan

        B357_045: state = state.PSH(9); goto B358_045; // PT = , Size = 9, Colour = dark blue

        B358_045: state = state.PSH(23); goto B359_045; // PT = , Size = 23, Colour = light blue

        B359_045: state = state.ADD; goto B360_045; // PT = , Size = 1, Colour = blue

        B360_045: state = state.PSH(6); goto B361_045; // PT = , Size = 6, Colour = magenta

        B361_045: state = state.PSH(23); goto B362_045; // PT = , Size = 23, Colour = dark magenta

        B362_045: state = state.PSH(5); goto B363_045; // PT = , Size = 5, Colour = light magenta

        B363_045: state = state.MUL; goto B364_045; // PT = , Size = 1, Colour = magenta

        B364_045: state = state.ADD; goto B365_045; // PT = , Size = 1, Colour = light red

        B365_045: state = state.DUP; goto B366_045; // PT = , Size = 1, Colour = light yellow

        B366_045: state = state.PSH(23); goto B367_045; // PT = , Size = 23, Colour = light magenta

        B367_045: state = state.SUB; goto B368_045; // PT = , Size = 1, Colour = magenta

        B368_045: state = state.PSH(9); goto B369_045; // PT = , Size = 9, Colour = dark red

        B369_045: state = state.PSH(23); goto B370_045; // PT = , Size = 23, Colour = light red

        B370_045: state = state.ADD; goto B371_045; // PT = , Size = 1, Colour = red

        B371_045: state = state.PSH(15); goto B372_045; // PT = , Size = 15, Colour = yellow

        B372_045: state = state.PSH(23); goto B373_045; // PT = , Size = 23, Colour = dark yellow

        B373_045: state = state.PSH(4); goto B374_045; // PT = , Size = 4, Colour = light yellow

        B374_045: state = state.MUL; goto B375_045; // PT = , Size = 1, Colour = yellow

        B375_045: state = state.ADD; goto B376_045; // PT = , Size = 1, Colour = light green

        B376_045: state = state.RD.DUP; goto B377_056; // PT = RD, Size = 1, Colour = light cyan

        B377_056: state = state.PSH(7); goto B377_063; // PT = , Size = 7, Colour = light blue

        B377_063: state = state.ADD; goto B377_064; // PT = , Size = 1, Colour = blue

        B377_064: state = state.PSH(2); goto B377_066; // PT = , Size = 2, Colour = magenta

        B377_066: state = state.ROT; goto B377_067; // PT = , Size = 1, Colour = dark magenta
        ...
        B383_045: state = state.ADD; goto B384_045; // PT = , Size = 1, Colour = dark cyan

        B384_045: state = state.PSH(23); goto B385_045; // PT = , Size = 23, Colour = dark blue

        B385_045: state = state.PSH(5); goto B386_045; // PT = , Size = 5, Colour = light blue

        B386_045: state = state.MUL; goto B387_045; // PT = , Size = 1, Colour = blue

        B387_045: state = state.RD.DUP; goto B388_053; // PT = RD, Size = 1, Colour = light magenta

        B388_053: state = state.PSH(10); goto B388_063; // PT = , Size = 10, Colour = light blue

        B388_063: state = state.SUB; goto B388_064; // PT = , Size = 1, Colour = blue

        B388_064: state = state.PSH(2); goto B388_066; // PT = , Size = 2, Colour = dark magenta

        B388_066: state = state.ROT; goto B388_067; // PT = , Size = 1, Colour = light magenta
        ...
        B393_045: state = state.SUB; goto B394_045; // PT = , Size = 1, Colour = cyan

        B394_045: state = state.PSH(9); goto B395_045; // PT = , Size = 9, Colour = dark blue

        B395_045: state = state.PSH(23); goto B396_045; // PT = , Size = 23, Colour = light blue

        B396_045: state = state.ADD; goto B397_045; // PT = , Size = 1, Colour = blue

        B397_045: state = state.RD.PSH(2); goto B400_047; // PT = RD, Size = 1, Colour = magenta
        ...
        B402_059: state = state.LR.PSH(1); goto B404_045; // PT = LR, Size = 1, Colour = cyan
        ...
        B406_045: state = state.PSH(1); goto B409_045; // PT = , Size = 1, Colour = red
        ...
        B329_092: state = state.DUP; goto B308_093; // PT = , Size = 1, Colour = red
        ...
        B308_093: state = state.PSH(22); goto B329_094; // PT = , Size = 22, Colour = blue
        ...
        B329_094: state = state.ADD; goto B308_095; // PT = , Size = 1, Colour = dark blue
        ...
        B308_095: state = state.PSH(22); goto B307_096; // PT = , Size = 22, Colour = dark magenta
        ...
        B307_096: state = state.PSH(23); goto B326_097; // PT = , Size = 23, Colour = light magenta
        ...
        B326_097: state = state.PSH(4); goto B329_098; // PT = , Size = 4, Colour = magenta
        ...
        B360_093: state = state.ADD; goto B354_094; // PT = , Size = 1, Colour = dark red

        B329_098: state = state.MUL; goto B329_099; // PT = , Size = 1, Colour = dark magenta
        ...
        B354_094: state = state.PSH(7); goto B338_095; // PT = , Size = 7, Colour = dark yellow

        B329_099: state = state.ADD; goto B329_100; // PT = , Size = 1, Colour = red

        B403_045: state = state.RR.PSH(1); goto B404_045; // PT = RR, Size = 1, Colour = magenta
        ...
        B338_095: state = state.PSH(23); goto B358_096; // PT = , Size = 23, Colour = light yellow

        B329_100: state = state.RL.DUP; goto B312_101; // PT = RL, Size = 1, Colour = yellow
        ...
        B358_096: state = state.PSH(3); goto B360_097; // PT = , Size = 3, Colour = yellow

        B312_101: state = state.PSH(13); goto B311_101; // PT = , Size = 13, Colour = light blue
        ...
        B360_097: state = state.MUL; goto B360_098; // PT = , Size = 1, Colour = dark yellow

        B311_101: state = state.SUB; goto B309_101; // PT = , Size = 1, Colour = blue
        ...
        B391_093: state = state.ADD; goto B391_094; // PT = , Size = 1, Colour = dark red

        B360_098: state = state.ADD; goto B360_099; // PT = , Size = 1, Colour = green

        B309_101: state = state.PSH(2); goto B308_101; // PT = , Size = 2, Colour = dark magenta
        ...
        B391_094: state = state.DUP; goto B376_095; // PT = , Size = 1, Colour = dark yellow

        B360_099: state = state.RL.DUP; goto B343_100; // PT = RL, Size = 1, Colour = cyan

        B308_101: state = state.ROT; goto B307_101; // PT = , Size = 1, Colour = light magenta
        ...
        B376_095: state = state.PSH(16); goto B391_096; // PT = , Size = 16, Colour = dark magenta

        B343_100: state = state.PSH(4); goto B342_100; // PT = , Size = 4, Colour = light blue
        ...
        B391_096: state = state.ADD; goto B391_097; // PT = , Size = 1, Colour = light magenta

        B342_100: state = state.ADD; goto B340_100; // PT = , Size = 1, Colour = blue
        ...
        B391_097: state = state.RL.DUP; goto B374_098; // PT = RL, Size = 1, Colour = light red

        B340_100: state = state.PSH(2); goto B339_100; // PT = , Size = 2, Colour = magenta
        ...
        B421_093: state = state.PSH(2); goto B422_094; // PT = , Size = 2, Colour = dark red

        B374_098: state = state.PSH(2); goto B373_098; // PT = , Size = 2, Colour = light blue

        B339_100: state = state.ROT; goto B338_100; // PT = , Size = 1, Colour = dark magenta
        ...
        B422_094: state = state.MUL; goto B401_095; // PT = , Size = 1, Colour = light red

        B373_098: state = state.SUB; goto B371_098; // PT = , Size = 1, Colour = blue
        ...
        B401_095: state = state.PSH(22); goto B400_096; // PT = , Size = 22, Colour = dark yellow

        B371_098: state = state.PSH(2); goto B370_098; // PT = , Size = 2, Colour = dark magenta
        ...
        B400_096: state = state.PSH(23); goto B419_097; // PT = , Size = 23, Colour = light yellow

        B370_098: state = state.ROT; goto B369_098; // PT = , Size = 1, Colour = light magenta
        ...
        B419_097: state = state.PSH(4); goto B422_098; // PT = , Size = 4, Colour = yellow
        ...
        B422_098: state = state.MUL; goto B422_099; // PT = , Size = 1, Colour = dark yellow
        ...
        B329_106: state = state.ADD; goto B321_107; // PT = , Size = 1, Colour = dark magenta

        B422_099: state = state.ADD; goto B422_100; // PT = , Size = 1, Colour = green
        ...
        B360_106: state = state.ADD; goto B345_107; // PT = , Size = 1, Colour = light cyan

        B321_107: state = state.PSH(9); goto B307_108; // PT = , Size = 9, Colour = dark red

        B422_100: state = state.DUP; goto B410_101; // PT = , Size = 1, Colour = cyan
        ...
        B345_107: state = state.PSH(16); goto B338_108; // PT = , Size = 16, Colour = light blue

        B307_108: state = state.PSH(23); goto B329_109; // PT = , Size = 23, Colour = light red

        B410_101: state = state.PSH(13); goto B422_102; // PT = , Size = 13, Colour = yellow
        ...
        B338_108: state = state.PSH(23); goto B358_109; // PT = , Size = 23, Colour = blue

        B329_109: state = state.ADD; goto B322_110; // PT = , Size = 1, Colour = red

        B422_102: state = state.SUB; goto B422_103; // PT = , Size = 1, Colour = dark yellow

        B391_103: state = state.SUB; goto B374_104; // PT = , Size = 1, Colour = blue

        B358_109: state = state.PSH(3); goto B360_110; // PT = , Size = 3, Colour = dark blue

        B322_110: state = state.PSH(8); goto B307_111; // PT = , Size = 8, Colour = yellow

        B422_103: state = state.DUP; goto B408_104; // PT = , Size = 1, Colour = light green

        B374_104: state = state.PSH(18); goto B369_105; // PT = , Size = 18, Colour = dark magenta

        B360_110: state = state.MUL; goto B360_111; // PT = , Size = 1, Colour = light blue

        B307_111: state = state.PSH(23); goto B326_112; // PT = , Size = 23, Colour = dark yellow

        B408_104: state = state.PSH(15); goto B422_105; // PT = , Size = 15, Colour = light red

        B369_105: state = state.PSH(23); goto B388_106; // PT = , Size = 23, Colour = light magenta

        B360_111: state = state.ADD; goto B360_112; // PT = , Size = 1, Colour = dark magenta

        B326_112: state = state.PSH(4); goto B329_113; // PT = , Size = 4, Colour = light yellow

        B422_105: state = state.ADD; goto B422_106; // PT = , Size = 1, Colour = red

        B388_106: state = state.PSH(4); goto B391_107; // PT = , Size = 4, Colour = magenta

        B360_112: state = state.RL.DUP; goto B343_113; // PT = RL, Size = 1, Colour = dark red

        B329_113: state = state.MUL; goto B329_114; // PT = , Size = 1, Colour = yellow

        B422_106: state = state.DUP; goto B404_107; // PT = , Size = 1, Colour = yellow

        B391_107: state = state.MUL; goto B391_108; // PT = , Size = 1, Colour = dark magenta

        B343_113: state = state.PSH(7); goto B342_113; // PT = , Size = 7, Colour = light blue

        B329_114: state = state.ADD; goto B329_115; // PT = , Size = 1, Colour = light green

        B404_107: state = state.PSH(19); goto B422_108; // PT = , Size = 19, Colour = magenta

        B391_108: state = state.ADD; goto B391_109; // PT = , Size = 1, Colour = red

        B342_113: state = state.SUB; goto B340_113; // PT = , Size = 1, Colour = blue

        B329_115: state = state.DUP; goto B329_116; // PT = , Size = 1, Colour = light cyan

        B422_108: state = state.SUB; goto B422_109; // PT = , Size = 1, Colour = dark magenta

        B391_109: state = state.RL.DUP; goto B374_110; // PT = RL, Size = 1, Colour = yellow

        B340_113: state = state.PSH(2); goto B339_113; // PT = , Size = 2, Colour = dark magenta

        B329_116: state = state.PSH(1); goto B329_117; // PT = , Size = 1, Colour = light yellow

        B422_109: state = state.DUP; goto B412_110; // PT = , Size = 1, Colour = light red

        B374_110: state = state.PSH(1); goto B373_110; // PT = , Size = 1, Colour = light blue

        B339_113: state = state.ROT; goto B338_113; // PT = , Size = 1, Colour = light magenta

        B329_117: state = state.ADD; goto B329_118; // PT = , Size = 1, Colour = yellow

        B412_110: state = state.PSH(11); goto B422_111; // PT = , Size = 11, Colour = light blue

        B373_110: state = state.ADD; goto B371_110; // PT = , Size = 1, Colour = blue
        ...
        B329_118: state = state.DUP; goto B316_119; // PT = , Size = 1, Colour = green

        B422_111: state = state.ADD; goto B414_112; // PT = , Size = 1, Colour = blue

        B371_110: state = state.PSH(2); goto B370_110; // PT = , Size = 2, Colour = magenta
        ...
        B316_119: state = state.PSH(14); goto B329_120; // PT = , Size = 14, Colour = red

        B414_112: state = state.PSH(9); goto B400_113; // PT = , Size = 9, Colour = magenta

        B370_110: state = state.ROT; goto B369_110; // PT = , Size = 1, Colour = dark magenta
        ...
        B329_120: state = state.ADD; goto B329_121; // PT = , Size = 1, Colour = dark red

        B400_113: state = state.PSH(23); goto B422_114; // PT = , Size = 23, Colour = dark magenta
        ...
        B329_121: state = state.RL.DUP; goto B312_122; // PT = RL, Size = 1, Colour = dark yellow

        B422_114: state = state.ADD; goto B401_115; // PT = , Size = 1, Colour = light magenta
        ...
        B312_122: state = state.PSH(5); goto B311_122; // PT = , Size = 5, Colour = light blue

        B401_115: state = state.PSH(22); goto B400_116; // PT = , Size = 22, Colour = light red
        ...
        B360_119: state = state.ADD; goto B360_120; // PT = , Size = 1, Colour = red

        B311_122: state = state.SUB; goto B309_122; // PT = , Size = 1, Colour = blue

        B400_116: state = state.PSH(23); goto B419_117; // PT = , Size = 23, Colour = red
        ...
        B360_120: state = state.DUP; goto B339_121; // PT = , Size = 1, Colour = yellow

        B309_122: state = state.PSH(2); goto B308_122; // PT = , Size = 2, Colour = dark magenta

        B419_117: state = state.PSH(4); goto B422_118; // PT = , Size = 4, Colour = dark red
        ...
        B339_121: state = state.PSH(22); goto B360_122; // PT = , Size = 22, Colour = magenta

        B308_122: state = state.ROT; goto B307_122; // PT = , Size = 1, Colour = light magenta

        B422_118: state = state.MUL; goto B422_119; // PT = , Size = 1, Colour = light red
        ...
        B360_122: state = state.ADD; goto B360_123; // PT = , Size = 1, Colour = dark magenta
        ...
        B422_119: state = state.ADD; goto B422_120; // PT = , Size = 1, Colour = dark yellow
        ...
        B360_123: state = state.DUP; goto B352_124; // PT = , Size = 1, Colour = dark red
        ...
        B422_120: state = state.DUP; goto B420_121; // PT = , Size = 1, Colour = dark green
        ...
        B352_124: state = state.PSH(9); goto B338_125; // PT = , Size = 9, Colour = dark blue
        ...
        B420_121: state = state.PSH(3); goto B422_122; // PT = , Size = 3, Colour = dark red
        ...
        B338_125: state = state.PSH(23); goto B360_126; // PT = , Size = 23, Colour = light blue
        ...
        B422_122: state = state.SUB; goto B413_123; // PT = , Size = 1, Colour = light red
        ...
        B360_126: state = state.ADD; goto B352_127; // PT = , Size = 1, Colour = blue
        ...
        B413_123: state = state.PSH(10); goto B422_124; // PT = , Size = 10, Colour = yellow
        ...
        B352_127: state = state.PSH(9); goto B338_128; // PT = , Size = 9, Colour = magenta
        ...
        B422_124: state = state.RL.PSH(2); goto B420_127; // PT = RL, Size = 1, Colour = dark yellow
        ...
        B338_128: state = state.PSH(23); goto B357_129; // PT = , Size = 23, Colour = dark magenta
        ...
        B357_129: state = state.PSH(4); goto B360_130; // PT = , Size = 4, Colour = light magenta
        ...
        B391_119: state = state.SUB; goto B391_120; // PT = , Size = 1, Colour = dark magenta

        B360_130: state = state.MUL; goto B360_131; // PT = , Size = 1, Colour = magenta

        B329_127: state = state.ADD; goto B329_128; // PT = , Size = 1, Colour = light magenta
        ...
        B391_120: state = state.DUP; goto B375_121; // PT = , Size = 1, Colour = light red

        B360_131: state = state.ADD; goto B360_132; // PT = , Size = 1, Colour = light red

        B329_128: state = state.DUP; goto B327_129; // PT = , Size = 1, Colour = light red
        ...
        B375_121: state = state.PSH(17); goto B391_122; // PT = , Size = 17, Colour = light blue

        B360_132: state = state.DUP; goto B358_133; // PT = , Size = 1, Colour = light yellow

        B327_129: state = state.PSH(3); goto B329_130; // PT = , Size = 3, Colour = light blue
        ...
        B391_122: state = state.ADD; goto B380_123; // PT = , Size = 1, Colour = blue

        B358_133: state = state.PSH(3); goto B360_134; // PT = , Size = 3, Colour = light magenta

        B329_130: state = state.ADD; goto B314_131; // PT = , Size = 1, Colour = blue
        ...
        B380_123: state = state.PSH(12); goto B391_124; // PT = , Size = 12, Colour = magenta

        B360_134: state = state.ADD; goto B360_135; // PT = , Size = 1, Colour = magenta

        B314_131: state = state.PSH(16); goto B329_132; // PT = , Size = 16, Colour = magenta
        ...
        B391_124: state = state.RL.PSH(2); goto B389_127; // PT = RL, Size = 1, Colour = dark magenta

        B360_135: state = state.DUP; goto B349_136; // PT = , Size = 1, Colour = red

        B329_132: state = state.RL.PSH(2); goto B327_135; // PT = RL, Size = 1, Colour = dark magenta
        ...
        B349_136: state = state.PSH(12); goto B360_137; // PT = , Size = 12, Colour = blue
        ...
        B360_137: state = state.ADD; goto B346_138; // PT = , Size = 1, Colour = dark blue
        ...
        B346_138: state = state.PSH(15); goto B360_139; // PT = , Size = 15, Colour = dark magenta
        ...
        B360_139: state = state.RL.PSH(2); goto B358_142; // PT = RL, Size = 1, Colour = light magenta
        ...
        B408_129: state = state.RL.PSH(3); goto B417_133; // PT = RL, Size = 1, Colour = cyan
        ...
        B377_129: state = state.LD.PSH(1); goto B391_131; // PT = LD, Size = 1, Colour = cyan
        ...
        B315_137: state = state.LD.PSH(1); goto B329_139; // PT = LD, Size = 1, Colour = cyan
        ...
        B346_144: state = state.LD.PSH(1); goto B360_146; // PT = LD, Size = 1, Colour = cyan
